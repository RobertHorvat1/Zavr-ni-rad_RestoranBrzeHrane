...
<div id="container">
    ...
    <h1 id="novo">KVALITETA HRANE</h1>
        <section>
            <p id="tekst1">Ovdje možete komentirati kakva je kvaliteta naše hrane. 
            Da li cijena opravdava našu ponudu hrane? Bilo kakvu primjedbu oko hrane možete ostaviti ovdje, 
            te će naš administrator pokušati riješiti problem.</p>
        </section>    
    </div>
    <?php
        if(isset($_SESSION['Korisnicko_ime'])){
