...
<div id="container">
    ...
    <?php
        ...
        $num_per_page=5;
        $start_from = ($page - 1)*5;
        $narudzba = $db_handle->runQuery("SELECT * FROM `narudzba` WHERE `Korisnicko_ime` = '$Korisnicko_ime' ORDER BY `Datum` DESC LIMIT $start_from, $num_per_page");
        if($narudzba==TRUE) {
    ...
    ?>  
        ...
        <table class="tbl-narudzba" style="width:100%" cellpadding="4" cellspacing="4">
            <tr>
                <th>ID:</th>
                <td><?php echo $narudzba[$key]["ID"]; ?><br></td>
            </tr>
            <tr>
                <th>Korisničko ime:</th>
                <td><?php echo $narudzba[$key]["Korisnicko_ime"]; ?><br></td>
            </tr>
            <tr>
                <th>Adresa:</th>
                <td><?php echo $narudzba[$key]["Adresa"]; ?><br></td>
            </tr>
            <tr>
                <th>Datum:</th>
                <td><?php echo $narudzba[$key]["Datum"]; ?><br></td>
            </tr>
            <tr>
            ...
            <tr>
                <th>Ukupna cijena:</th>
                <td><?php echo $narudzba[$key]["Ukupna_cijena"]." kn"; ?></td>
            </tr>
        </table>
        <p><br></p>
        </div>
        ...
        ?>
        <?php
        $page_query = "SELECT * FROM `narudzba` WHERE `Korisnicko_ime` = '$Korisnicko_ime'";
